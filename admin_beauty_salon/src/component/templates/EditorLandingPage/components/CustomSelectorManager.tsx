...
export default function CustomSelectorManager({
  ...
  return (
    <div className="gjs-custom-selector-manager p-2 flex flex-col gap-2 text-left">
      ...
      <div
        className={cx(
          "flex items-center gap-2 flex-wrap p-2 bg-white border-red-400 border rounded min-h-[64px]"
        )}
      >
        {targetStr ? (
          <button
        ...
        {selectors.map((selector) => (
          <div
            ...
            className="px-2 py-1 flex items-center gap-1 whitespace-nowrap rounded"
          >
